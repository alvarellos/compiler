    ...
    implements ProcedureIF 
{
    ...
    // Nuevas
	private ArrayList<SymbolParameter> _formalParametersList = new ArrayList<SymbolParameter>();
    ...
    {
        // TODO : Student Work --- Diego. Se añade lo que falta del método
    	
    	if(label == null) 
    	{	
			//label = new LabelFactory().create(scope.getName() + "_" + name);
    		label = new LabelFactory().create(name);
		}
	...
	public ArrayList<SymbolParameter> get_formalParametersList() {
		return _formalParametersList;
	}

	public void set_formalParametersList(ArrayList<SymbolParameter> _formalParametersList) {
		this._formalParametersList = _formalParametersList;
	}
