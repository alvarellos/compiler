    ...
    implements TemporalIF 
{
    ...
    // Nuevas
    private int     size = 1;
    private boolean containRefenceAddress = false;
    int desplazamiento;
	...
	public void setContainRefenceAddress(boolean containRefenceAddress) 
	{
		this.containRefenceAddress = containRefenceAddress;
	}
	
    public boolean isContainRefenceAddress() 
    {
		return containRefenceAddress;
	}
